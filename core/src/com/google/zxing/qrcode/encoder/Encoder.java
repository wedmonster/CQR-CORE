...
public final class Encoder {
  ...
  public static int chooseMaskPattern(BitArray bits, ErrorCorrectionLevel ecLevel, int version,
   ...
   */
  public static void terminateBits(int numDataBytes, BitArray bits) throws WriterException {
   ...
   */
  public static void interleaveWithECBytes(BitArray bits, int numTotalBytes,
   ...
   */
  public static void appendLengthInfo(int numLetters, int version, Mode mode, BitArray bits)
      throws WriterException {
   ...
   */
  public static void appendBytes(String content, Mode mode, BitArray bits, String encoding)
      throws WriterException {
  ...
  public static void appendECI(ECI eci, BitArray bits) {
